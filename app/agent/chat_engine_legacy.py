"""ChatEngine LEGACY — 方案 C 重构前的备份（保留为回滚资产）

⚠️ DO NOT IMPORT FROM PRODUCTION CODE ⚠️

此文件是 2026-06-14 方案 C 架构重构前的 chat_engine.py 完整副本。
保留 30 天作为回滚资产（铁律 6 / kill switch fallback）：
