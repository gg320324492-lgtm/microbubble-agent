...
class SelfRAGChecker:
    ...
    async def check_relevance(
        ...
        Returns:
            {"can_answer": bool, "reason": str, "missing": str, "confidence": float}
        """
        try:
...
- confidence: 你对判断的置信度"""
            ...
            return {"can_answer": True, "reason": "无法判断，默认通过", "missing": "", "confidence": 0.5}

        except Exception as e:
            logger.warning(f"Self-RAG check failed: {e}")
            return {"can_answer": True, "reason": "检查失败，默认通过", "missing": "", "confidence": 0.3}
