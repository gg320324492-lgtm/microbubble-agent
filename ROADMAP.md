...
| 维度 | 状态 | 最近更新 |
|------|------|----------|
| 后端 | Phase 1-6 + 声纹系统 5 修复 + 反幻觉七重过滤 | 2026-06-02 |
| 知识库 | 自主进化知识大脑（实体图谱+假设+量化推理）| 2026-05-27 |
| 会议系统 | 声纹会议 wave 3b + 微信 enroll_voice + 192 维修正 + Celery tasks 修复 | 2026-06-02 |
| 部署 | 阿里云 Nginx+FRP + 本地 Docker 8 services + SSH 拉取（130s→5s） | 2026-06-02 |
| Webhook 自动部署 | SSH 拉取已端到端验证（commit `cd92ad6`）| 2026-06-02 |
