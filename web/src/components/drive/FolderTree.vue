...
<template>
  ...
  <!-- W89-P-1 a11y: scrollable-region-focusable 修复 — scrollable 容器必须有 tabindex="0" 才能键盘 focus
       + role="tree" 标识 ARIA 语义 (WAI-ARIA TreeView Pattern) -->
  <div class="folder-tree drive-folder-tree" tabindex="0" role="tree" aria-label="文件夹树">
    <!-- 顶级固定节点: 我的网盘 (渐变激活) -->
