<!--
  FileRequestListView.vue — v2 PR7 文件请求管理页 (Dropbox 招牌 "收作业")

  路由: /drive/requests
  功能:
  - 我创建的文件请求列表 (默认仅 active)
...
<style>
[data-theme="dark"] .file-request-list-view .request-item {
  background: var(--color-bg-card);
  border-color: var(--color-border);
}
[data-theme="dark"] .file-request-list-view .request-toolbar {
  background: var(--color-bg-card);
}
</style>
