"""W86 mini-13 B analytics heartbeat end-to-end contract tests.

Re-applies the W86 mini-11 B heartbeat after the W86 mini-12 celery partial
init fix; the suite validates that production ``search_logs`` ingestion is
re-observed without polluting retrieval-quality metrics.
"""
...
def test_analytics_heartbeat_writes_system_metrics_row():
    ...
    # search_logs.created_at is TIMESTAMP WITHOUT TIME ZONE -> naive UTC.
