...
> **Base head**: `fbc11908e` (W-N-BGE +3 收口)
> **派工 brief 假设**: W-N-G+ +5 修 4 FAIL agent 可能成功 / 部分 / 失败, 本文为 3 种情况都预留决策路径
...
- (c) W-N-OBS +1 (`1896fee64`) / W-N-GRAND +1 (`c011ebd09`) / W-N-BGE +1/2/3 期间有 schema 改动但未追溯
...
- CLAUDE.md § "W-N-G+ 派工 brief 8/8 PASS vs 实测 4 FAIL 偏差" (历史段, 待 W-N-VERIFY +2 据实写)
