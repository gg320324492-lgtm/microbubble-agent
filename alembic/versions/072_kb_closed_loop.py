...
- W68 第 11 批 C-1 alembic 串单链 rebase: down_revision 接 071_knowledge_rejected_retry (B-3 新位置)
- 文件名 072 保持不变 (main 067-069 间无 072 占用), 串单链最后第 2 节点
...
down_revision: Union[str, None] = "071_knowledge_rejected_retry"
