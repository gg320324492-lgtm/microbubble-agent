...
下接: 071_knowledge_rejected_retry 加 retry_count / next_retry_at / permanent_suspended
...
- W68 第 11 批 C-1 alembic 串单链 rebase: down_revision 接 069_drive_comments_recursive_func (main 当前 head)
- 文件名 066 → 070: 避开 main 已存在的 066_drive_comments_path / 067_drive_reactions / 068_drive_notification_dedup
"""
...
revision: str = "070_knowledge_rejected"
