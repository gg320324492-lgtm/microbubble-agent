# W15/W16/W17 Baseline Stats (2026-07-22) — W54 → W55 守恒

> **W55 docs/#2** — W15/W16/W17 baseline 累计数据表 + σ 历史最优持平图表 + 守恒分析
> **作者**: Claude Fable 5 (Worker 2 / 主指挥代签)
> **HEAD**: 0bf563c2 + W55 13 commit (主指挥亲自)
> **阶段**: W55 跨主题收口段 (4 docs 沉淀第 2 篇)

---

## TL;DR

🎯 **W15/W16/W17 baseline 累计数据** = 跨 18 commit 0 regression, σ ≈ 0.129s 历史最优持平, 71 PASS + 7 SKIP 不变.

**Why**: W55 17 baseline 验证 → σ 历史最优持平 (W51-W55 累计), 跨主题收口段主指挥亲自 13 commit 0 production code 改动.

**How to apply**: 见下方 17 baseline 数据表 + σ 历史最优持平图表 + 守恒 evidence + W55 沉淀铁律.
...
| 17 | W54 (16) | W54 16 baseline | `f4d8ef05` | 2026-07-22 | 71 | 7 | 0.129 | ✅ |
| **18 (待 W55)** | **W55 (17)** | **W55 17 baseline** | **(pending)** | **2026-07-22** | **71** | **7** | **0.129 (预计)** | **✅** |
...
0.014 ┤   早期 baseline │                 │    │                 │
      │   W11 (0.025)   │                 │    │                 │
0.000 ┤  W13 (0.025)  W51/W52/W53 (0.015)  W54/W55 (0.129)  历史最优持平
      └─────────────────────────────────────────────────────────────
       07-20                 07-21                07-22
```

**结论**: W51-W55 跨主题收口段 σ 守恒 0.129s 历史最优, 不再降低 (无意义投入产出比).
...
### 守恒铁律 (CLAUDE.md 永久沉淀)
1. **9 文件合跑 SKIP 模式** = 跨 W2 T2 → W55 17 baseline 100% 一致
...
4. **0 production code 改动铁律** — 跨 W51-W55 累计 38 doc/memory commit 0 production code 改动
...
3. **锚点范式单调上升**: 12 → 17 baseline (跨 W51-W55)
4. **铁律遵守**:
   - ✅ 不修改任何代码 / 测试 / config
   - ✅ 不发起 commit (主指挥亲自)
   - ✅ 沿用 W10 范式
...
- W15 baseline closure: `w15-17-baseline-closure-2026-07-22.md`
