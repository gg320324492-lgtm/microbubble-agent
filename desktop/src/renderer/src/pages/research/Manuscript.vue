...
<style scoped>
.manuscript{display:grid;grid-template-columns:minmax(190px,.72fr) minmax(420px,1.8fr) minmax(260px,1fr);min-width:0;min-height:100%;background:var(--research-bg-main);color:var(--research-text-primary)}
...
@media(max-width:1480px){.manuscript{grid-template-columns:minmax(176px,.66fr) minmax(380px,1.65fr) minmax(244px,.94fr)}.manuscript__outline,.manuscript__review{padding:var(--research-space-4)}.manuscript__editor{padding-inline:var(--research-space-6)}}
</style>
