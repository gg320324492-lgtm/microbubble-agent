...
const PAGE_ACCESSIBILITY: [string, (s: string) => boolean][] = [
  ...
  ["aside 区分主三栏", (s) => /aside class="data-analysis__col--dataset"/.test(s) && /aside class="data-analysis__col--interpretation"/.test(s)],
,
...
,
  ...
  ["Page main wrapper", (s) => s.includes('class="data-analysis"')],
  ["Page total grid", (s) => /<section class="data-analysis__grid"/.test(s)],
...
,
  ...
  ["Uses data-analysis class", (s) => s.includes('class="data-analysis"')],
...
,
  ...
  ["Panel uses ul+li structure", (s) => /<ul[^>]*>[\s\S]*<li/.test(s)],
