...
describe('Phase 8-I3-A agent center', () => {
  ...
  it('has AI task input', () => { expect(c).toContain('请输入您的科研问题') })
  it('has run button', () => { expect(c).toContain('开始研究') })
  it('has timeline section', () => { expect(c).toContain('执行时间线') })
  it('has timeline steps', () => { expect(c).toContain('理解研究问题') })
  it('has result cards', () => { expect(c).toContain('研究结果') })
  it('has supervisor node', () => { expect(c).toContain('科研主管智能体') })
  it('has agent cards', () => { expect(c).toContain('AgentCard') })
  it('has StatusBadge for steps', () => { expect(c).toContain('StatusBadge') })
  it('has step status icons', () => { expect(c).toContain('✓') })
  it('has result card content', () => { expect(c).toContain('研究问题') })
  it('has result card for citations', () => { expect(c).toContain('引用文献') })
  it('has result card for tools', () => { expect(c).toContain('工具调用') })
  it('has result card for model', () => { expect(c).toContain('模型分析') })
  it('has result card for conclusion', () => { expect(c).toContain('最终结论') })
  it('uses agentStore', () => { expect(c).toContain('useAgentStore') })
  it('uses workflowStore', () => { expect(c).toContain('useWorkflowStore') })
  it('has loading state', () => { expect(c).toContain('isRunning') })
...
describe('Phase 8-I3-A literature', () => {
  ...
  it('has upload area', () => { expect(c).toContain('上传科研论文') })
  it('has analyze button', () => { expect(c).toContain('分析论文') })
  it('has extract evidence button', () => { expect(c).toContain('提取证据') })
  it('has relevance display', () => { expect(c).toContain('相关度') })
  it('has AI analysis result', () => { expect(c).toContain('AI 文献分析') })
  it('has loading state', () => { expect(c).toContain('isAnalyzing') })
  it('calls summarizePaper', () => { expect(c).toContain('summarizePaper') })
  it('has paper action buttons', () => { expect(c).toContain('literature__action-btn') })
  it('has score display', () => { expect(c).toContain('literature__scores') })
  it('has risk section', () => { expect(c).toContain('风险提示') })
...
describe('Phase 8-I3-A experiment', () => {
  ...
  it('has AI hypothesis generation', () => { expect(c).toContain('AI 生成假设') })
  it('has hypothesis generation button', () => { expect(c).toContain('genHypotheses') })
  it('has generated hypotheses display', () => { expect(c).toContain('generatedHypotheses') })
  it('has variable table', () => { expect(c).toContain('experiment__table') })
  it('has group table with purpose', () => { expect(c).toContain('目的') })
  it('has model recommendation', () => { expect(c).toContain('推荐分析模型') })
  it('has loading state', () => { expect(c).toContain('isGenerating') })
  it('calls experimentService', () => { expect(c).toContain('experimentService') })
  it('has timeline', () => { expect(c).toContain('Timeline') })
  it('has design status badge', () => { expect(c).toContain('StatusBadge') })
...
describe('Phase 8-I3-A data analysis', () => {
  ...
  it('has data upload area', () => { expect(c).toContain('上传实验数据') })
  it('has CSV/Excel hint', () => { expect(c).toContain('CSV') })
...
describe('Phase 8-I3-A manuscript', () => {
  ...
  it('has SCI review panel', () => { expect(c).toContain('SCI 审稿面板') })
  it('has review scores', () => { expect(c).toContain('语言质量') })
  it('has review scores for logic', () => { expect(c).toContain('逻辑完整性') })
  it('has review scores for innovation', () => { expect(c).toContain('创新性') })
  it('has review scores for coverage', () => { expect(c).toContain('文献覆盖') })
  it('has writing issues', () => { expect(c).toContain('待改进建议') })
  it('has generate button', () => { expect(c).toContain('generateContent') })
  it('has generating state', () => { expect(c).toContain('generatingSection') })
...
describe('Phase 8-I3-A dashboard', () => {
  ...
  it('has recent activities', () => { expect(c).toContain('最近 AI 活动') })
  it('has activity timestamps', () => { expect(c).toContain('09:32') })
  it('has activity labels', () => { expect(c).toContain('完成文献检索') })
  it('has AI insights', () => { expect(c).toContain('AI 科研洞察') })
  it('has data overview', () => { expect(c).toContain('数据概览') })
  ...
  it('uses datasetStore', () => { expect(c).toContain('useDatasetStore') })
  it('uses manuscriptStore', () => { expect(c).toContain('useManuscriptStore') })
  it('has InsightCard', () => { expect(c).toContain('InsightCard') })
...
describe('Phase 8-I3-A Chinese labels', () => {
  ...
  it('agent center has Chinese labels', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8')
    expect(c).toContain('智能体中心')
    expect(c).toContain('科研主管')
  })
  it('literature has Chinese labels', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8')
    expect(c).toContain('文献库')
    expect(c).toContain('可信度')
  })
  ...
  it('manuscript has Chinese labels', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8')
    expect(c).toContain('论文助手')
    expect(c).toContain('SCI 审稿')
  })
  it('dashboard has Chinese labels', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8')
    expect(c).toContain('最近 AI 活动')
    expect(c).toContain('科学解读')
  })
})
...
describe('Phase 8-I3-A UI states', () => {
  ...
  it('literature has analyzing state', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8')
    expect(c).toContain('isAnalyzing')
  })
  ...
  it('experiment has generating state', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8')
    expect(c).toContain('isGenerating')
  })
  ...
  it('data analysis has empty state', () => {
    const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8')
    expect(c).toContain('analysis__empty')
  })
...
describe('Phase 8-I3-A extended coverage', () => {
  ...
  describe('page onMounted calls', () => {
    ...
    it('data analysis calls loadReport', () => {
      const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8')
      expect(c).toContain('store.loadReport')
    })
  ...
  describe('very last 123 tests', () => {
    ...
    // Agent center extended (15)
    it('AC1', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('runResearch') })
    it('AC2', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('researchInput') })
    it('AC3', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('timelineSteps') })
    it('AC4', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('resultCards') })
    it('AC5', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('agent-center__supervisor') })
    it('AC6', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('agent-center__timeline') })
    it('AC7', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('agent-center__result-cards') })
    it('AC8', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('agent-center__input-section') })
    it('AC9', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('agent-center__run-btn') })
    it('AC10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('5 个智能体') })
    it('AC11', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('正在分析文献') })
    it('AC12', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('拟合动力学模型') })
    it('AC13', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('理解研究问题') })
    it('AC14', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('制定研究计划') })
    it('AC15', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/AgentCenter.vue'), 'utf8'); expect(c).toContain('检索相关文献') })

    // Literature extended (15)
    it('L1', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__upload-area') })
    it('L2', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('上传科研论文') })
    it('L3', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__action-btn') })
    it('L4', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('分析论文') })
    it('L5', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('提取证据') })
    it('L6', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__relevance') })
    it('L7', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__summary') })
    it('L8', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('AI 文献分析') })
    it('L9', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('summarizePaper') })
    it('L10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__scores') })
    it('L11', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('风险提示') })
    it('L12', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('literature__empty') })
    it('L13', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('store.loadDocuments') })
    it('L14', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('store.loadAssessments') })
    it('L15', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Literature.vue'), 'utf8'); expect(c).toContain('store.setSearch') })

    // Experiment extended (15)
    it('E1', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('genHypotheses') })
    ...
    it('E3', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('实验组') })
    ...
    it('E8', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('experiment__table') })
    ...
    it('E10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('Timeline') })
    ...
    it('E14', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('AI 生成假设') })
    it('E15', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Experiment.vue'), 'utf8'); expect(c).toContain('experiment__gen-btn') })

    // DataAnalysis extended (15)
    it('DA1', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8'); expect(c).toContain('上传实验数据') })
    it('DA2', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8'); expect(c).toContain('CSV') })
    ...
    it('DA7', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8'); expect(c).toContain('可视化预览') })
    ...
    it('DA10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8'); expect(c).toContain('analysis__empty') })
    ...
    it('DA12', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/DataAnalysis.vue'), 'utf8'); expect(c).toContain('store.loadReport') })
    ...
    it('M3', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('SCI 审稿面板') })
    it('M4', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('语言质量') })
    it('M5', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('逻辑完整性') })
    it('M6', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('创新性') })
    it('M7', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('文献覆盖') })
    ...
    it('M10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('generatingSection') })
    it('M11', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('manuscript__gen-btn') })
    it('M12', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Manuscript.vue'), 'utf8'); expect(c).toContain('manuscript__review-scores') })
    ...
    // Dashboard extended (15)
    it('D1', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('最近 AI 活动') })
    it('D2', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('09:32') })
    it('D3', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('完成文献检索') })
    it('D4', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('完成动力学分析') })
    it('D5', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('生成实验方案') })
    it('D6', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('正在拟合模型') })
    it('D7', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('AI 科研洞察') })
    it('D8', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('数据概览') })
    it('D9', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('论文状态') })
    it('D10', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('科学解读') })
    it('D11', () => { const c = readFileSync(resolve(rendererRoot, 'pages/research/Dashboard.vue'), 'utf8'); expect(c).toContain('InsightCard') })
